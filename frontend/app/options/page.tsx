          ...
          {pathOptions.map((option, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative bg-gray-800/50 backdrop-blur-lg rounded-3xl border ${option.borderColor} p-8 hover:${option.shadowColor} hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:border-opacity-100`}
              >
                <div className="absolute -top-3 left-8">
                  <span className={`bg-gradient-to-r ${option.gradient} text-white px-4 py-1 rounded-full text-sm font-medium shadow-lg`}>
                    {option.badge}
                  </span>
                </div>
                ...
                <div className="text-center mb-8 pt-4">
                  <motion.div 
                    ...
                    className={`w-24 h-24 bg-gradient-to-r ${option.gradient} rounded-3xl mx-auto mb-6 flex items-center justify-center group-hover:shadow-lg transition-all duration-300`}
                  >
                ...
                <div className="bg-gray-700/30 rounded-2xl p-4 mb-8 border border-gray-600/30">
                  <div className="flex items-center mb-2">
                    <Zap className="w-4 h-4 text-yellow-400 mr-2" />
                    <span className="text-yellow-400 font-medium text-sm">Most Popular Features</span>
                  </div>
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`group/btn w-full bg-gradient-to-r ${option.hoverGradient} text-white px-8 py-4 rounded-2xl font-semibold transition-all duration-200 inline-flex items-center justify-center shadow-lg hover:shadow-xl relative overflow-hidden`}
                >
                  <span className="relative z-10 flex items-center">
                    {option.id === 'experienced' ? 'Continue as Experienced Founder' : 'Start Building My First Startup'}
                    <ArrowRight className="w-5 h-5 ml-2 group-hover/btn:translate-x-1 transition-transform" />
                  </span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 to-white/20 translate-x-[-100%] group-hover/btn:translate-x-[100%] transition-transform duration-600"></div>
                </motion.a>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 max-w-2xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full border-2 border-gray-800"></div>
